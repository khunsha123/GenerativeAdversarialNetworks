...
Original file is located at
    https://colab.research.google.com/drive/1tE6CTyUqdZ2mLg0d0bLsGPuZmh8jvR62
    ...
    for batch_idx, (real, _) in enumerate(dataloader):
        ...
        if batch_idx % 100 == 0:
            ...
            with torch.no_grad():
              ...
              real=np.transpose(torchvision.utils.make_grid(real[:32], normalize=True).cpu())
              plt.imshow(real)

              plt.subplot(1,2,2)
              plt.axis("off")
              plt.title("Fake Image")
              fake=np.transpose(torchvision.utils.make_grid(fake[:32], normalize=True).cpu())
              plt.imshow(fake)
              plt.show()